...
def settings_from_window(window) -> LayoutSettings:
    ...
    settings = LayoutSettings(
        ...
        cutter_knife_change_gap_mm=(window.cutter_settings.knife_change_gap.value()
                                    if cutting else 0),
        # Cutter quick mode only skips cutter-specific rotation searches. Free
        # layout evaluates normal, mixed and whole-batch rotation in one solve.
        allow_rotation=(not cutting and window.allow_rotation.isChecked()),
