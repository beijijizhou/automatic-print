...
from automatic_print.layout_engine.intake.metadata.source_metadata import size_key, source_size, source_block, block_key
...
def arrange_orders(orders, items, lanes, settings, prepared=None):
    from automatic_print.layout_engine.planning.base.pairing_index import indexed_sequence
