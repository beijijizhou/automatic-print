...
def indexed_sequence(orders, items, lanes, prepared):
    from automatic_print.layout_engine.orders.single_order_sequence import lane_fits, horizontal_savings
    ...
    from automatic_print.layout_engine.orders.color_policy import order_color_key
