...
def build_local_page(owner) -> QWidget:
    ...
    if hasattr(window, "label_settings"):
        ...
        from ...ui.automated_layout import install_automated_layout_control
        owner.automated_layout_control = install_automated_layout_control(window, owner)
        owner.batch_tools = build_batch_tools(
            owner.label_quick_panel, owner.automated_layout_control.run_button)
