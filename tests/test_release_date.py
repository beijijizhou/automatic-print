...
def test_local_release_date_is_fixed_and_separate_from_version():
    ...
    assert updater.version_tuple(__version__) == (0, 1, 63)


def test_remote_release_uses_publication_date(monkeypatch):
    data = {'tag_name': 'v0.1.64', 'html_url': 'https://example.com/release',
    ...
    assert update.display_version == '0.1.64 · 发版日期 2026-09-14'
