...
- 主窗口在所有工作区 Tab 上方固定显示全局生产排版模式，完整设置窗口也在所有参数 Tab 与滚动内容上方固定显示同一控件；两处直接镜像唯一的切膜模式状态。主界面明确分为“切膜机 · 刀码与补距”和“自动排版”；完整设置窗口的“切膜机”页集中所有切膜机相关参数，“自动排版”页集中旋转、并排、缩放、间距与膜方案比较。开发者模式再显示批次顺序和方案比较。切膜刀码开关在正常排版与上次
