...
```powershell
powershell -ExecutionPolicy Bypass -Command "irm 'https://raw.githubusercontent.com/beijijizhou/automatic-print/main/windows/bootstrap-test-computer.ps1?v=0.1.430' | iex"
```
...
```bash
.venv/bin/python -m pytest -vv --tb=short -ra --durations=20
```
